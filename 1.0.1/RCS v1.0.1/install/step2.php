...
if(isset($_SESSION['step2'])){
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
        ...
        if(preg_match('/[^a-zA-Z0-9_ ]/', $username)){
            ...
            $db->query("INSERT INTO `users` VALUES (null, '$username', '$password', '13-18', '225', 'fdsfdsf@gmail.com', '". date('M/d/Y') ."', 4, '". $_SERVER['REMOTE_ADDR'] ."', 0, ". time() .", '". substr(hash(sha256, time()), 35) ."', 0, 0, 1, 0, 0, 0)");
