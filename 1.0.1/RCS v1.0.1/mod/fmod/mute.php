			...
			<div class="widescroll-bgimg">
				...
				<div class="widescroll-content">
                                        <?php
                                            ...
                                            elseif($user->checkMute($_POST['username']))
                                            {
                                            ...
                                            {
                                                echo 'You can\'t mute for an "undefined" length.';
                                            }
                                            else
                                            {
                                                //add the mute
                                                ...
                                                //success! user muted
                                                ?>
                                                    <b><?php echo $_POST['username']; ?></b> was muted for <b><?php echo $_POST['mute']; ?></b> hours. <a href="index.php">Back to MCP</a> | <a href="mute.php">Mute Another User</a></b>
                                                <?php
                                            }
                                        ?>
				</div>
