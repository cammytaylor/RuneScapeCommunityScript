                    ...
                    <div id="t_container">
                        ...
                        <div id="t_container_bottom">
                                ...
                                <?php
                                    ...
                                    if($rank < 4)
                                        $new = $database->processQuery("SELECT `id`,`title`,`date` FROM `messages` WHERE `opened` = '0' AND `receiver` = ? AND ". time() ." - `timestamp` < '7889231' ORDER BY `date` DESC", array($username), true);
                                    else
