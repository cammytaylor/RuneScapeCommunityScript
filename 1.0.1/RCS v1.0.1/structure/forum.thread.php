...
{ 
    ...
    public function formatPost($content, $username, forum $forum = null)
    {
        ...
        if($rank > 2)
        {
            ...
            $bbcode = array('#\[b\](.+?)\[\/b\]#', '#\[i\](.+?)\[\/i\]#', '#\[url=(.+?)](.+?)\[\/url\]#', '#\[u\](.+?)\[\/u\]#', '#:lolbert:#');
            $replace = array('<b>$1</b>', '<i>$1</i>', '<a href="$1">$2</a>', '<u>$1</u>', '<img src="../img/forum/smileys/lolbert.png">');
