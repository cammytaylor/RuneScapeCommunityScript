				...
				<div class="widescroll-content">
                                        <?php
                                                ...
                                                ?>
                                                    ...
                                                    <div id="blackfields">
                                                        <form action="ban.php" method="POST">
                                                            <table>
                                                                <tr><td>Username</td><td><input type="text" class="button" name="username" <?php echo (isset($_GET['target'])) ? 'value="'.$_GET['target'].'"' : ''; ?> maxlength="12"></td></tr>
                                                                <tr><td><b><font color="red">MARK THIS TO UNBAN</font></b></td><td><input type="checkbox" name="unban"></td></tr>
                                                                ...
                                                                <tr><td>Done?</td><td><input type="submit" value="Ban/Unban"></td></tr>
                                                            </table>
                                                        </form>
                                                    </div>
                                            ...
                                            else
                                            {
                                                ...
                                                $banned = ($user->isDisabled($selected_user)) ? true : false;
                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            echo '<b>'. $selected_user .'</b> is already banned/disabled. <input type="button" value="Back" onclick="goBack()" />';
                                                        }
                                                    }
                                                }
                                            }
