...
//two different username variables used to show threads/posts, so make a function so we can specify the username we want to use
function belowTitleOptions($username_specific, $rankOfViewer)
{
    //rankofviewer = $rank, just in a visible scope
    //determine whether to show extra mod options under titles
    if($rankOfViewer > 2)
    {
        $belowTitle = '<br/><br/><a href="../mod/fmod/mute.php?target='. $username_specific .'">Mute/Unmute</a>';
        if($rankOfViewer >= 4) $belowTitle .= '<br/><a href="../admin/ban.php?target='. $username_specific .'">Ban/Unban</a>';
    }
                                                ...
                                                <tbody>
                                                                        <tr>
                                                                                <td class="leftpanel">
                                                                                        ...
                                                                                        <div class="modtype">
                                                                                            <?php 
                                                                                                echo $forum->getPostTitle($details['username']);
                                                                                                if($config['postcount'] == 1) { ?><br/><br/>Post Count: <?php echo $user->postcount($details['username']); }
                                                                                                belowTitleOptions($details['username'], $rank);
                                                                                            ?>
                                                                                        </div>
                                                                                        <div class="msgcommands"></div>
                                                                                </td>
                                                                                <td class="rightpanel">
                                                                                        ...
                                                                                        <div class="msgcontents">
                                                                                                <?php echo $base->br2nl((empty($details['moved'])) ? $thread->formatPost($details['content'], $details['username'], $base, $forum) : $details['content']); ?>
                                                                                                </div>
                                                    ...
                                                    <tbody>
                                                                            <tr>
                                                                                    <td class="leftpanel">
                                                                                            ...
                                                                                            <div class="modtype">
                                                                                                <?php 
                                                                                                    echo $forum->getPostTitle($reply['username']);
                                                                                                    if($config['postcount'] == 1) { ?><br/><br/>Post Count: <?php echo $user->postcount($reply['username']); }
                                                                                                    belowTitleOptions($reply['username'], $rank);
                                                                                                ?>
                                                                                            </div>
                                                                                            <div class="msgcommands"></div>
                                                                                    </td>
                                                                                    <td class="rightpanel">
                                                                                            <div class="msgtime"><?php echo $date; ?></div>
                                                                                            <div class="msgcontents">
                                                                                                    <?php echo $base->br2nl($thread->formatPost($reply['content'], $reply['username'], $base)); ?>
                                                                                                    </div>
