...
<ul>
<li class="i-world"><a href="img/worldmap.jpg">World map</a></li>
...
<legend><?php echo $data['wb_abbr']; ?> Moderators</legend>
<ul>
<li class="i-pmod"><a href="modcenter/index.php">Visit the moderation center</a></li>
<li class="i-pmod"><a href="modcenter/info.php">Learn about <?php echo $data['wb_abbr']; ?> moderators</a></li>
<li class="i-pmod"><a href="modcenter/current.php">View the <?php echo $data['wb_abbr']; ?> moderation team</a></li>
</ul>
</fieldset>
...
<a href="<?php echo ($user->isLoggedIn()) ? ($play_url != '') ? $play_url : 'forums/' : 'login.php'; ?>" class="button" id="button-right"><span class="lev1"></span><br style="line-height: 200%">Play <?php echo $data['wb_abbrev']; ?><br>(Existing user)</a>
</div>
